...
//@003    - Эмулируем Клава мышь, в т.ч. через wheel в XboxProfiles без геммора с профилями
//@004    - Правки в print из-за выведения Hotkeys копок режимов в консоль
//@005    - в Appstatus для новых Режимов и выведения привязанных кнопок в консоль
//@006    - add чтоб после смены профией (ALT+Q / PS+Left/Right) автоматически вызывалась нужная функция загрузки профиля
